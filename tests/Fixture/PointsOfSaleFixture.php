 ...
 * PointsOfSaleFixture
 */
class PointsOfSaleFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'points_of_sale_ibfk_1' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'points_of_sale_ibfk_2' => ['type' => 'foreign', 'columns' => ['city_id'], 'references' => ['cities', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'points_of_sale_ibfk_3' => ['type' => 'foreign', 'columns' => ['country_id'], 'references' => ['countries', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
