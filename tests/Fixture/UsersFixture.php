...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'last_access' => ['type' => 'timestamp', 'length' => null, 'null' => false, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'enabled' => 1,
                'last_access' => 1579754093,
                'created' => '2020-01-23 04:34:53',
                'modified' => '2020-01-23 04:34:53',
            ],
        ];
        parent::init();
    }
